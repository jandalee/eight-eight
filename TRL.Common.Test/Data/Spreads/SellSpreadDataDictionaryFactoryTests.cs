...
{
    [TestClass]
    public class SellSpreadDataDictionaryFactoryTests
    {
        ...
        [TestMethod]
        public void SellSpreadDataDictionary_makes_dictionary()
        {
            ...
            this.qProvider.Update(0, "RTS-12.13_FT", 143100, 300, 0, 0);
            this.qProvider.Update(0, "Si-12.13_FT", 0, 0, 33200, 100);
            this.qProvider.Update(0, "Eu-12.13_FT", 0, 0, 41000, 200);
