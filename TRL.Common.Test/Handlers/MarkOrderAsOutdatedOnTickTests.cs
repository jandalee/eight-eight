...
{
    [TestClass]
    public class MarkOrderAsOutdatedOnTickTests
    {
        ...
        public void Handlers_Setup()
        {
            ...
            MarkOrderAsOutdatedOnTick cancelHandler = new MarkOrderAsOutdatedOnTick(this.strategyHeader, this.outdateSeconds, this.tradingData, new NullLogger());
        }

        [TestMethod]
        public void Handlers_cancel_non_filled_outdated_strategy_order_to_open_long()
        {
        ...
        [TestMethod]
        public void Handlers_cancel_non_filled_outdated_strategy_order_to_open_short()
        {
