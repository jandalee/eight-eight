...
{
    [TestClass]
    public class StrategyStopLossByPointsOnTickMeasureFromTradePriceTests
    {
        ...
        public void Setup()
        {
            ...
            this.handler =
                new StrategyStopLossByPointsOnTick(this.strategyHeader, this.tradingData, this.signalQueue, new NullLogger());
        ...
        [TestMethod]
        public void StrategyStopLossOnTick_is_Identified_test()
        {
        ...
        {
            this.tradingData.Get<ObservableCollection<Tick>>().Add(new Tick(this.strategyHeader.Symbol, DateTime.Now, 120000, 31));
            Assert.AreEqual(0, this.signalQueue.Count);
        }
        ...
        {
            Trade firstTrade = this.tradingData.AddSignalAndItsOrderAndTrade(this.buySignal, this.buySignal.Price, 5);
            Trade secondTrade = this.tradingData.AddSignalAndItsOrderAndTrade(this.buySignal, this.buySignal.Price, 5);
            double amount = Math.Abs(this.tradingData.GetAmount(this.strategyHeader));
        ...
        {
            Trade firstTrade = this.tradingData.AddSignalAndItsOrderAndTrade(this.buySignal, this.buySignal.Price, 5);
            this.tradingData.AddSignalAndItsOrderAndTrade(this.buySignal, this.buySignal.Price, 3);
        ...
        {
            Trade openTrade = this.tradingData.AddSignalAndItsOrderAndTrade(this.buySignal);
        ...
        {
            Trade firstTrade = this.tradingData.AddSignalAndItsOrderAndTrade(this.buySignal, this.buySignal.Price, 2);
            Trade secondTrade = this.tradingData.AddSignalAndItsOrderAndTrade(this.buySignal, this.buySignal.Price, 3);
        ...
        {
            Trade firstTrade = this.tradingData.AddSignalAndItsOrderAndTrade(this.sellSignal, this.sellSignal.Price, 5);
            Trade secondTrade = this.tradingData.AddSignalAndItsOrderAndTrade(this.sellSignal, this.sellSignal.Price, 5);
            double amount = Math.Abs(this.tradingData.GetAmount(this.strategyHeader));
        ...
        {
            Trade firstTrade = this.tradingData.AddSignalAndItsOrderAndTrade(this.sellSignal, this.sellSignal.Price, 5);
            Trade secondTrade = this.tradingData.AddSignalAndItsOrderAndTrade(this.sellSignal, this.sellSignal.Price, 3);
            double amount = Math.Abs(this.tradingData.GetAmount(this.strategyHeader));
            firstTrade.Order.Cancel(DateTime.Now, "cancel order");
            Assert.IsTrue(firstTrade.Order.IsCanceled);
        ...
        {
            this.tradingData.AddSignalAndItsOrderAndTrade(this.sellSignal);
        ...
        {
            Trade firstTrade = this.tradingData.AddSignalAndItsOrderAndTrade(this.sellSignal, this.sellSignal.Price, 3);
            Trade secondTrade = this.tradingData.AddSignalAndItsOrderAndTrade(this.sellSignal, this.sellSignal.Price, 4);
