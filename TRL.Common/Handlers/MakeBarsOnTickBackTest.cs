...
{
    public class MakeBarsOnTickBackTest : AddedItemHandler<Tick>
    {
        ...
        public MakeBarsOnTickBackTest(BarSettings barSettings, ITimeTrackable timeTracker, IDataContext tradingData, ILogger logger)
