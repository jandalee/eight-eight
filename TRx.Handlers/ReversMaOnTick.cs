...
{
    public class ReversMaOnTick:AddedItemHandler<Tick>
    {
        ...
        public ReversMaOnTick(StrategyHeader strategyHeader, IDataContext tradingData, ObservableQueue<Signal> signalQueue, ILogger logger)
